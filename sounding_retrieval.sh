#!/bin/bash
#data retrieval for Tornado ANN project
#sounding data from UWyoming Upper Air database
#will download all records from 1973 to 2017 for all station codes in station_list.txt for 12Z
#to download 00Z, change FROM\=${day}12\&T0\=${day}12 to FROM\=${day}00\&T0\=${day}00 in each instance
#can be stopped and started, wil re-check for existing files
#requries ./data folder (to be run from outside it)
